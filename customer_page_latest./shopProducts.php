    ...
    <div class="modal" tabindex="-1" id="<?php echo $successCartModal?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="bi bi-check-circle-fill text-success">
            ...
            <div class="modal-footer">
                <a href="cart.php" class="btn btn-primary goToCart">Go to Cart</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="modal" tabindex="-1" id="<?php echo $successOrderModal?>">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary checkout" data-bs-toggle="modal" data-bs-target="#checkoutModal">Checkout</button>
            </div>
          </div>
        </div>
      </div>
