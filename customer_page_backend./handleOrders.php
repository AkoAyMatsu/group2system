            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<td class="d-flex">
                            <img src="' . '../' . $row['product_img'] . '" alt="" srcset="" class="rounded--gallon my-3 mx-2">
                    ...
                    echo '<td class="py-5">' . 'Php ' . $row['total_price']. '</td>';
                    echo '<td class="py-5">' . $row['order_status']. '</td>';
                    echo '</tr>';
                }
            } else {
                echo '<tr>
                        <td colspan="7" class="fw-bold text-center">NO HISTORIES FOUND</td>  
                      </tr>';
            }
        } else {
